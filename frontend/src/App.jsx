...
export const App = () => {
    return (
        <Routes>
            ...
            <Route element={<ProtectedPath role={Roles.ADMIN} />}>
            ...
            <Route element={<ProtectedPath role={Roles.STUDENT} ></ProtectedPath>}>
            ...
            <Route element={<ProtectedPath role={Roles.SCANNER} ></ProtectedPath>}>
